...
urlpatterns = [
    ...
    path(r'^bookDetail/(?P<pk>\d+)$', views.BookDetail.as_view(), name='BookDetail'),
    path(r'^bookEdit/(?P<pk>\d+)$', views.BookUpdate.as_view(), name='BookEdit'),
    path(r'^bookDelete/(?P<pk>\d+)$', views.BookDelete.as_view(), name='BookDelete'),
    #URL LISTA DE RESERVAS:\
